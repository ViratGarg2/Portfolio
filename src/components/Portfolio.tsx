...
const Portfolio: React.FC = () => {
  ...
  const controlsAnimation = useScrollAnimation('fade-down', { threshold: 0.1, animationDelay: 200 });
  const carouselAnimation = useScrollAnimation('zoom-in', { threshold: 0.1, animationDelay: 400 });
  const dotsAnimation = useScrollAnimation('fade-up', { threshold: 0.1, animationDelay: 600 });
    ...
    >
      <div className="container mx-auto relative z-10">
        ...
        <div 
          ...
          className={`text-center mb-14 ${titleAnimation.className}`}
        >
        ...
        <div className="relative">
          {/* Enhanced Navigation Controls with animation */}
          <div 
            ref={controlsAnimation.ref as React.RefObject<HTMLDivElement>}
            className={`flex items-center justify-between mb-8 ${controlsAnimation.className}`}
          >
            {/* Left Controls */}
          ...
          <div 
            ref={carouselAnimation.ref as React.RefObject<HTMLDivElement>}
            className={carouselAnimation.className}
          >
            <Carousel
              setApi={setApi}
              opts={{
          ...
          {/* Enhanced Dots Navigation with animation */}
          <div 
            ref={dotsAnimation.ref as React.RefObject<HTMLDivElement>}
            className={`flex justify-center mt-8 gap-2 ${dotsAnimation.className}`}
          >
